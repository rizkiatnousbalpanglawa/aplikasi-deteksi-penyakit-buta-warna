		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="" action="" method="POST" enctype="multipart/form-data">
					...
					<div class="wrap-input100 rs1 validate-input" data-validate="Kata sandi dibutuhkan">
	...
	<?php
		if (isset($_POST['masuk'])) {
			...
			if (mysqli_num_rows($cek) === 1) {
				//$get = $cet->fetch_assoc();
				$_SESSION['login'] = true;
				echo "<script>alert('Selamat Datang Admin!');location='../admin'</script>";
			}else {
				echo "<script>alert('Username dan Kata Sandi Tidak Ditemukan!');location='index.php'</script>";
			}
		}
